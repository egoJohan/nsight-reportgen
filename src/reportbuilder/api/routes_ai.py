...
def ai_slide_title(
    ...
    # Only the headline is AI-generated. The subtitle deliberately stays empty so the
    # slide falls back to the MATERIAL question text (deterministic, not per-report),
    # which is what a grouped (battery/multi) question should show under its headline.
    return {"title": title}

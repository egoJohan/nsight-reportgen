...
class TestDeletion:
    ...
    # Deleting a study's LAST dataset makes it read-only: definitions go, decks
    # stay — see test_dataset_deletion.py (spec 2026-09-24). The tests that
    # pinned the earlier opposite rule (reports kept, decks dropped) are gone.
